...
function showLoadingError(authError) {
    ...
    if (authError) {
        sError = `
            ...
            im Plugin <a href="${OBS_PLUGIN_URL}" target="_blank">OBS-Websockets</a> entsprechen.
        `;
    } else {
    ...
    sError += `
        ...
        dass das Plugin <a href="${OBS_PLUGIN_URL}" target="_blank">OBS-Websockets</a> aktiviert ist.
    `;
